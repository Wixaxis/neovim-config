...
local M = {
  base_mappings = {
    ...
    { keys = { 'n', '<leader>lg', { desc = 'Open [L]azy[G]it' } },                cmd = Snacks.lazygit.open,                            desc = 'open lazygit' },
    { keys = { 'n', '<leader>lh', { desc = 'Open [L]azyGit - file [h]istory' } }, cmd = Snacks.lazygit.log_file,                        desc = 'open lazygit - current file history' },
