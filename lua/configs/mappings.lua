...
local M = {
  base_mappings = {
    { 'n', '<leader><leader>', utils.commander,                { desc = 'Commander' } },
    ...
    { 'n', '<leader>x',        ':bdelete\n',                   { desc = 'Close buffer [x]' } },
    { 'n', '<A-t>',            utils.floating_terminal,        { desc = 'Toggle floating terminal' } }, -- TODO: expand terminals support (create, search/select, remove, notify, send, move)
    { 't', '<A-t>',            utils.floating_terminal,        { desc = 'Toggle floating terminal' } },
