...
M.get_transparency = function() return vim.g.neovide_transparency end
...
M.set_macos_option_key_is_meta = function(mode)
  ...
  if mode == 'auto' then
    vim.api.nvim_create_autocmd('InsertEnter', {
      callback = function() vim.g.neovide_input_macos_option_key_is_meta = 'none' end,
      pattern = '*',
    })
    vim.api.nvim_create_autocmd('InsertLeave', {
      callback = function() vim.g.neovide_input_macos_option_key_is_meta = 'both' end,
      pattern = '*',
    })
...
M.set_colorscheme_autocmd = function()
  ...
  vim.api.nvim_create_autocmd('Colorscheme', {
    callback = function() M.set_transparency(M.get_transparency()) end,
  })
end
